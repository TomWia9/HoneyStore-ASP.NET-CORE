...
namespace HoneyStore.Migrations
{
    ...
    [Migration("20200702115444_AddCartAndHoneyItemsTablesAndRelationsBetweenClientAndCartAndCartAndHoneyItem")]
    partial class AddCartAndHoneyItemsTablesAndRelationsBetweenClientAndCartAndCartAndHoneyItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoneyStore.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HoneyStore.Models.Cart", b =>
                {
                    b.HasOne("HoneyStore.Models.Client", "Client")
                        .WithOne("Cart")
                        .HasForeignKey("HoneyStore.Models.Cart", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HoneyStore.Models.HoneyItem", b =>
                {
                    b.HasOne("HoneyStore.Models.Cart", "Cart")
                        .WithMany("Honeys")
